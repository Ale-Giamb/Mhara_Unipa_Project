...
def generate_launch_description():
    ...
    simulate_arg = DeclareLaunchArgument(
        'simulate',
        default_value='false',
        description='Se true, avvia il mock invece dei nodi reali'
    )
    ...
    qi_unipa_mock_node = Node(
        package='qi_unipa',
        executable='qi_unipa_mock',
        name='qi_unipa_mock',
        output='screen',
    ...
    return LaunchDescription([
        ...
        qi_unipa_tablet_node,
        qi_unipa_server_node,
